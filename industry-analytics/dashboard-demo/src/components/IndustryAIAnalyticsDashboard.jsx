    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between h-16">
        <div className="flex items-center space-x-4">
          <img
            src="https://storage.googleapis.com/frontier-public-assets/industry-analytics-dashboard-logo.png"
            alt="Industry Analytics"
            className="h-8 w-auto mr-4"
          />
          <h1 className="text-xl font-semibold text-gray-900">{t('industryAIAnalytics')}</h1>
        </div>
